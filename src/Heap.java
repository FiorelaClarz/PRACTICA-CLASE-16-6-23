...
/**
 * La clase Heap<T> es una implementación de un montículo binario utilizando un
 * ArrayList
 * para almacenar los elementos. El tipo genérico T se limita a aquellos tipos
 * que
 * implementan la interfaz Comparable<T>, lo que significa que los elementos
 * pueden ser
 * comparados entre sí.
 *
 */
